...
export default function ScholarshipForm() {
  ...
  return (
    <>
      ...
      {/* Error State */}
      {error && !loading && (
        <div className="bg-rose-50 border border-rose-200 rounded-2xl p-6 mb-8 text-center max-w-2xl mx-auto shadow-sm">
          ...
          <h3 className="text-rose-900 font-bold text-base mb-1">
            Informasi Layanan
          </h3>
          <p className="text-rose-700 text-sm leading-relaxed max-w-md mx-auto mb-4">
            {error}
          </p>
          <button
            type="button"
            onClick={() => {
              setError(null);
              const formEl = document.getElementById("scholarshipForm") as HTMLFormElement | null;
              formEl?.requestSubmit();
            }}
            className="inline-flex items-center gap-2 bg-rose-600 hover:bg-rose-700 text-white text-xs font-semibold px-4 py-2 rounded-lg transition-colors cursor-pointer"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
